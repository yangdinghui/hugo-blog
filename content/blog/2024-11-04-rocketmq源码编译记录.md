...
#### 5.1增加启动配置
![NamesrvStartup启动配置](https://img.rebotgpt.top/2024/11/d4eb7c5b8248a54826810d172478c52c.jpg)
``` bash
...
#### 6.1增加启动配置
![BrokerStartup启动配置](https://img.rebotgpt.top/2024/11/ae365ef14b9c6c2738ebac7ec8625aad.jpg)
``` bash
ROCKETMQ_HOME=/Users/tomato/IdeaProjects/learn/sourcecode/rocketmq
```
若还报错
